...
# 正是 CONTRACT.md §6 开篇那条审计发现（cme Ex2 说 +19.1%、当时的 Ex8 说 −1.2%；
# 那张季度柱已于 2026-09 删除，读数是当时的证据）。
...
#   同页当时的 Ex8 说 −1.2%；那张季度柱已于 2026-09 按所有者指令删除，今天的 cme Ex8
#   是另一张图，读数是当时的证据），所以 2026-09 全站改口径时抬头一并换掉。
