...
_GLOSSARY = [
    ...
    # 「Lump Premium」那一项在 2026-09-12 之前对 2025-09 ~ 2026-08 是假话：官方那一年把行名改长、
    # PDF 里折成两行，解析器只读到下半截 `Index Futures`，这一行没被加进来。解析器已修
    # （fetch/sgx.py 口径坑 19），库里那 12 格由 build/basefill/sgx_iron_ore_lump.py 更正。
    ('铁矿石',
