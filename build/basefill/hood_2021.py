...
Earnings Supplement 才补上的（本脚本用的 Q1'23 那份就有）。再往前没有任何月度数 ——
所以本 CSV 的月度历史到 2021-01 为止，**不硬凑**。
（2026-09-14 补充：更早的并不是「什么都没有」—— S-1 与其后的 10-Q 印着 2017–2019 年末与 2020
逐季末的 Net Cumulative Funded Accounts / AUC，招股书的客户增长时间轴图上还有 2014–2016 年末的
入金账户数。那些是时点值、不是月度序列，由 build/basefill/hood_ipo.py 单独存进
series/hood_ipo_pit.csv，只喂页面上两张「全部已披露历史」的长图，不进本 CSV。）
