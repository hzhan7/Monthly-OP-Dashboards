...
# 天花板已经查到 2011-06，不再是「没查过」：2026-09-16 从 EDGAR 取回 2012-07-17 起的
# 历次申报，连同原有的三期，**8 份**（报告月 Jun-2012 / Dec-2012 / Mar-2013 / Jun-2013 /
# Sep-2013 / Dec-2013 / Mar-2014 / Jun-2014，窗口合起来覆盖 2011-06…2014-06）里
# 'percentage of client assets' 命中数**逐份都是 0**。所以 2014-10-15 那期是**首次刊印**，
# 不只是「本地最早的一份」。再往前（2011-06 之前）仍未查，真要推的话还是老规矩：
# 去看原件有没有这一行，**不要**照着这个常数反推「官方那时没披露」。
#
# 2026-09-16 追记：天花板那几期当初是**整份解析不出来**的，「没有这一行」只能靠手工搜
# 字符串得到。现在 parse_edgar_monthly() 认得这一代版式了（三层病因见模块 docstring），
# 8 份全都能解析出 13 个月 × 2 列（total_client_assets_usdbn 与 new_brokerage_accounts_k），
