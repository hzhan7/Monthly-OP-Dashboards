...
6. **序列起点 2018-01。**（原文写的是「理由是会计准则」——
   ...
   逐月营收的口径没有断。**START_MONTH 保持 2018-01 不变**，但理由改成两条：
   ① 那是上游落库边界；② 2016–2017 那两年有合并范围变动（立錡并入、傑發出表），
   而它们的确切并表/出表月份至今没从官方原文核到 —— 没核到月份就不该往前接。
   年度月营收表有 2008 年起的月度数（2017 年 12 个月相加 = 238,216,318 千元，
   与 FY2018 财报的 2017 年比较数逐字相等），所以「取不到」从来不是理由。
