...
| `primary`   | LSE Main Market / AIM factsheet xlsx      | 24   | **两段列起点不同**：`aim_*` 11 列 2017-01 → 2026-07（缺 2019-09），`mm_*` 13 列 2018-05 → 2026-07（缺 2022-12）；两个缺月都是官方自己的洞 |
...
口径坑 A：**起点不是四个，是七个** —— 宽表必然是「左上角空一大片」。
    2026-08-19 实测的填充度（86 个数据列）：2016-01 那一行只有 orderbook 的 17 列，
    2017-01 起 55 列（+ tradeweb 27 + AIM 11），2018-05 起 68 列（Main Market 那 13 列
    才进来），2024-08 起 72 列，到 2026-07 是 80 列（LCH 三块各有各的滚动窗口）。
    连「一路一个起点」都不成立：primary 内部两个市场差 16 个月，lch 内部三个法人
