...
| 指控 | 结论 | 证据 |
|---|---|---|
| **(a) 只抓最新一期却声称多年历史** | ❌ 不成立 | 我实抓 `marketshare26.xlsx`：250 个月、2005-09..2026-06、**零断档**。**2019 与 2020 全部 12 个月逐月实测存在**，我打印了 2019-01 / 2019-12 / 2020-03 / 2020-12 的原始值（见 §三 E1 表）。且原文**主动声明** A 组只有 19 个月、不能回溯 —— 这是自曝其短，不是虚报 |
