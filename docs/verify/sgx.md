...
| `turnover_velocity_pct` | Overall Turnover Velocity（换手率）。**2018 年才有，2017 及以前天然为空** |
...
| 2018-01 | 才有 `turnover_velocity_pct` | —— |
...
- 一次性回填 2015-01 ~ 2026-06 需下 138 份 PDF，约 80 MB、~10 分钟，一次性成本可接受。
