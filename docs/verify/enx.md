...
- 同一版里另有几列冲突，**不在本次采纳范围**，照旧写 `cache/enx_restatements.csv`：
  - `mktcap_eurtn`：2025-11..2026-02 为 −0.14% ~ −0.17%；另有 2026-03/04 的 1e-5 级差，以及 2026-06/07 的浮点表示差；
  - `adv_bonds_retail_cleared_kcontracts`：2026-06 +19.4%；
  - `money_raised_new_listings_eurm`：2026-06 +8.5%，2026-07 +1.5%；
  - `listed_funds`：2026-06 2178 → 2173；
  - `athex_money_raised_followon_eurm`：2026-06 533 → 532.79；
  - `csd_settlement_instructions_m` 及其 athex 列：2026-06 各多 18 笔。
